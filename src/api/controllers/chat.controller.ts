...
export class ChatController {
  ...
  public async markAllMessagesRead({ instanceName }: InstanceDto, data: MarkAllMessagesReadDto) {
    return await this.waMonitor.waInstances[instanceName].markAllMessagesRead(data);
  }
